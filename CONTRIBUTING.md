...
1. To begin, [fork this project], clone your fork, and add our upstream.
   ...
   git clone https://github.com/<your-username>/storyblok-address
   # Navigate to the newly cloned directory
   cd storyblok-address
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/maoberlehner/storyblok-address
...
[already been reported]: https://github.com/maoberlehner/storyblok-address/issues
[fork this project]:     https://github.com/maoberlehner/storyblok-address/fork
